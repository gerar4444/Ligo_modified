...
The experiments to assess the viability of the convex hull are documented in test.ipybn. The trained models are not included due to their size, so the appropiate placeholder has to be changed to reproduce the results.
